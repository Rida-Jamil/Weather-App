...
const Temp = () => {
    ...
    useEffect(() => {
        const fetchApi = async () => {
            const url = `https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?q=${search}&units=metric&appid=62e14aa3dda9264d389331be96db9312`
